...
import (
	...
	"github.com/ronanzindev/restapiauth/domain/users"
	"github.com/ronanzindev/restapiauth/services"
...
func Get(c *gin.Context) {
	...
	if err != nil {
		restErr := errors.NewBadRequestError("user id should be a integer")
		c.JSON(restErr.Status, restErr)
		return
	}
